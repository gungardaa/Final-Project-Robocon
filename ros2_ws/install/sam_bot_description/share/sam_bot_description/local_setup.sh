...
: ${AMENT_CURRENT_PREFIX:="/home/gungardaa/ros2_ws/install/sam_bot_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sam_bot_description/environment/sam_bot_description.sh"
